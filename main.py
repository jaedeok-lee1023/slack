...
def main():
    for cluster in clusters:
        ...
        notice_msg = (
            ...
            f"\n"
            f":k체크: 수도 동파 및 온도 저하 우려로 출입문과 오버헤드도어 는 *<https://static.wixstatic.com/media/50072f_cf5cd03551aa4e4a8849e16f8a06fd7e~mv2.png|꼭 사용 후 폐쇄> 바랍니다.\n"
